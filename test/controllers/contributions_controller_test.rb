...
class ContributionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contribution" do
    assert_difference('Contribution.count') do
      post contributions_url, params: { contribution: { author: @contribution.author, text: @contribution.text, title: @contribution.title, url: @contribution.url } }
    end
  ...
  test "should update contribution" do
    patch contribution_url(@contribution), params: { contribution: { author: @contribution.author, text: @contribution.text, title: @contribution.title, url: @contribution.url } }
